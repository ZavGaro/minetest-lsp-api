...
---@field get_2d fun(self:self, pos:lt.Vector): lt.ValueNoise
-- Returns 3D noise value at `pos={x=,y=,z=}`.
---@field get_3d fun(self:self, pos:lt.Vector): lt.ValueNoise

---@overload fun(seeddiff, octaves, persistence, spread):lt.ValueNoise Deprecated.
---@param noiseparams lt.ValueNoiseParams
---@return lt.ValueNoise
...
---@param buffer lt.ValueNoise[]|nil
---@return lt.ValueNoise[]
...
---@param slice_offset lt.Vector
---@param slice_size lt.Vector
---@param buffer lt.ValueNoise[]|nil
---@return lt.ValueNoise[]
...
-- returned).
---@param size lt.Vector
-- If `buffer` is not nil, this table will be used to store the result
-- instead of creating a new table.
---@param buffer lt.ValueNoiseMap|nil
---@return lt.ValueNoiseMap
