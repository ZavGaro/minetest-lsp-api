...
---
---As auth data is not removed, `core.player_exists` will continue to return true.
---
---Call `core.remove_player_auth(name)` as well if you want to remove auth data too.
---@param name string
